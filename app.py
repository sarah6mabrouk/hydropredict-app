...
st.markdown("""
    ...
    <div class="navbar" id="navbar">
        <button class="nav-button" onclick="window.location.href='/?page=home'">Home</button>
        <button class="nav-button" onclick="window.location.href='/?page=about'">About</button>
        <button class="nav-button" onclick="window.location.href='/?page=contact'">Contact</button>
    </div>
...
<div class='tableauPlaceholder' id='viz168'>
  <noscript><a href='#'><img alt='Dashboard' src='https://public.tableau.com/static/images/In/InternalPumpLeakage/Dashboard1/1_rss.png' style='border: none' /></a></noscript>
  <object class='tableauViz' width='100%' height='900' style='display:none;'>
    <param name='host_url' value='https%3A%2F%2Fpublic.tableau.com%2F' />
    <param name='embed_code_version' value='3' />
    <param name='site_root' value='' />
    <param name='name' value='InternalPumpLeakage/Dashboard1' />
    <param name='tabs' value='no' />
    <param name='toolbar' value='yes' />
    <param name='static_image' value='https://public.tableau.com/static/images/In/InternalPumpLeakage/Dashboard1/1.png' />
